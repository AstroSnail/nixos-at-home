...

{
  ...
  config = {
    ...
    hosts.soon.yggd-pub = "cc407aa1e3fa49c3c6251c689f066afac7e0f8b4cf5744e0cd18446cf32fe51f";
    # Portugal (centered at the Picoto da Melriça)
    hosts.soon.loc = "39 41 40 N 8 7 50 W 592m 10m 600000m 2000m";
    hosts.soon.sshfp = "4 2 e3cde17417165ec78a4f26f2438ce43b142d9d87ef594e73171269b01d1a8632";
    ...
    hosts.sea.yggd-pub = "010dfebad3b4649b587501b9dfe1219411bfb413d5a3cd499be2fe1aa64676f3";
    # OVHcloud Gravelines
    hosts.sea.loc = "51 1 N 2 9 E 0m 500m 2000m 100m";
    hosts.sea.sshfp = "4 2 8541fb35fc4db160d2836bf49f5e239c9f5869037c4851777f72d51704e5655f";
    ...
    hosts.smol.yggd-pub = "0e0efe3a795819f123ad998745ed92b28b909eff789546e720617c5ca6039f95";
    #hosts.smol.sshfp = "";
    ...
    hosts.soon-prime.yggd-pub = "eaa4fee18f61d37eda21da80d7b199cd1478dbb5a4cf1d45869b5189bbb83896";
    hosts.soon-prime.sshfp = "4 2 17e13bf0ed8a0d7a9f492c4d5cd5825d3cee65d5747e7b2bd7580057faec48c0";

    #hosts.shinx.wg-addr = "";
    #hosts.shinx.wg-pub = "";
    hosts.shinx.yggd-addr = "200:2853:f73e:b83a:4275:16bf:208:abe4";
    hosts.shinx.yggd-pub = "ebd60460a3e2dec574a07efbaa0db3d640e8c80da7321dcd2585b2ad6d1571e9";
    ...
    hosts.sunrise.sshfp = "4 2 9ae2cb1a3c3276dce2aba204bc0db398a0a01c75a253af174bfa74c5d4bfafd1";
    ...
    hosts.sea2.sshfp = "4 2 f8a66351be3c68ff22da9dd23136e8979ef6da4a0c731276abc9b2ff8f0bed61";
