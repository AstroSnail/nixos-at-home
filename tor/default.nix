      ...
      ++ [
        {
          port = 80;
          target = {
            unix = "/run/nginx/onion.socket";
          };
        }
        {
          port = 443;
          target = {
            unix = "/run/nginx/onion-https.socket";
          };
        }
      ];
    secretKey = "/var/lib/tor/onion/astroslomofimguyolej7mlaofxbmczuwepljo5h5vjldxmy3me6mjid.onion/hs_ed25519_secret_key";
